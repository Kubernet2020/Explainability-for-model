...
def set_node_label(G, synset):
    ...
    nx.set_node_attributes(G, {
        ...
        synset_to_wnid(synset):match_classes(synset)
        #*
    }, 'label')

#Mass Modify
def match_classes(synset):
    classes = {
        'f05933834': 'BENIGN',
        'f03497657': 'DoS Hulk',
        'f05254795': 'PortScan',
        'f03441112': 'DDoS',
        'f04356056': 'DoS GoldenEye',
        'f04453666': 'FTP-Patator',
        'f03236735': 'SSH-Patator',
        'f03057021': 'DoS slowloris',
        'f04254777': 'DoS Slowhttptest',
        'f03605598': 'Web Attack',
        'f02854739': 'Bot',
        'f04231272': 'Infiltration',
        'f05563770': 'Heartbleed'

    }
    if(synset.pos() + ('0' + str(synset.offset())) in classes.keys()):
        return classes[synset.pos() + ('0' + str(synset.offset()))]
    else:
        return ''
#*
...
MODEL_FC_KEYS = (
    ...
    'model.last_layer.3.weight', 'layerf.weight', 'hidden3.weight')
...
def build_induced_graph(wnids, checkpoint, model=None, linkage='ward',
    ...
    print('centers shap: ', centers.shape)
    G = nx.DiGraph()
